                    ...
                    <div className="space-y-4">
                        ...
                        <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-gray-600 group-hover:text-gray-900 transition-colors select-none leading-tight">
                                Autorizo el tratamiento de mis datos personales de acuerdo con la <Link href="/terms" className="text-brand hover:underline font-medium">Política de Privacidad</Link> de NotifyCar para recibir notificaciones vehiculares.
                            </span>
                        </label>
                    </div>
